        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between mb-10">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button className="shrink-0 shadow-xl shadow-primary/20 hover:shadow-primary/30 transition-all active:scale-[0.98] rounded-full px-6 text-sm font-medium h-11">
            ...
            <DialogContent className="sm:max-w-[480px]">
              ...
              <form action={createAction} className="grid pt-4 gap-6">
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="name" name="name" placeholder="e.g. Minibar Fridge, AC Compressor" required className="h-12 rounded-xl bg-zinc-50 border-zinc-200/60 focus-visible:ring-primary" />
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Input id="assetCategory" name="category" placeholder="e.g. HVAC, Kitchen, In-Room" className="h-12 rounded-xl bg-zinc-50 border-zinc-200/60 focus-visible:ring-primary" />
                </div>
        ...
        <div className="backdrop-blur-2xl bg-white/50 border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl p-4 sticky top-6 z-20 mb-8">
          <form className="flex flex-col sm:flex-row sm:items-center gap-3" method="get">
            <div className="flex-1 relative group">
              ...
              <Input id="q" name="q" defaultValue={query} placeholder="Search equipment by name or type..." className="h-12 w-full pl-11 rounded-xl bg-white border-zinc-200/50 shadow-sm transition-all focus-visible:ring-primary focus:bg-white" />
            </div>
