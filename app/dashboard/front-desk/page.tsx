    ...
    <div className="page-shell">
      <div className="page-container">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="page-title">Front Desk Command Center</h1>
            <p className="page-subtitle">Arrivals, departures, and in-house operations in one view.</p>
          </div>
...
function MetricCard({ title, value }: { title: string; value: number }) {
  return (
    <Card className="glass-panel">
      ...
      <CardContent>
        <div className="text-3xl font-semibold tracking-tight text-balance text-zinc-900">{value}</div>
      </CardContent>
    </Card>
  );
}
...
function ReservationList({
  ...
  return (
    <Card className="glass-panel">
      ...
      <CardContent>
        {items.length === 0 ? (
          <p className="page-subtitle">{empty}</p>
        ) : (
