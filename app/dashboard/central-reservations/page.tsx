    ...
    <div className="page-shell">
      <div className="page-container">
            ...
            relatedPages={[
              {
                ...
                label: "Reservations",
                description: "Detailed reservation management happens after central booking or transfer.",
              },
            ]}
          />
        </div>
        ...
        <Card className="glass-panel mt-6 border-zinc-200/80 bg-linear-to-br from-white via-zinc-50/70 to-white">
          <CardHeader><CardTitle className="text-base">Cross-Property Workflow</CardTitle></CardHeader>
          <CardContent className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-1.5">
              <p className="text-sm font-medium text-zinc-900">Create or transfer reservations in one guided flow.</p>
              <p className="text-sm text-zinc-600">Use numbered steps to reduce jumping between forms and screens.</p>
            </div>
            <WorkflowStepperSheet
              ...
              steps={[
                { title: "Create at target property", description: "Build new reservation from central desk." },
                { title: "Transfer between properties", description: "Move an existing reservation to a new property/room type." },
              ]}
            >
              <div className="grid gap-6">
                <section className="space-y-3 rounded-2xl border border-zinc-200 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-semibold text-zinc-900">Create reservation at property</h2>
                  </div>
                  <form action={createAction} className="grid gap-3">
                    <div className="grid gap-2">
                      <Label htmlFor="wf-targetPropertyId">Target Property</Label>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="grid gap-2">
                        ...
                        <Input id="wf-createCheckIn" name="checkIn" type="date" required />
                      </div>
                      <div className="grid gap-2">
                        <Label htmlFor="wf-createCheckOut">Check-out</Label>
                        <Input id="wf-createCheckOut" name="checkOut" type="date" required />
                      </div>
                    </div>
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="grid gap-2">
                        <Label htmlFor="wf-adults">Adults</Label>
                        <Input id="wf-adults" name="adults" type="number" min={1} defaultValue={1} />
                      </div>
                      <div className="grid gap-2">
                        <Label htmlFor="wf-children">Children</Label>
                        <Input id="wf-children" name="children" type="number" min={0} defaultValue={0} />
                      </div>
                    </div>
                ...
                <section className="space-y-3 rounded-2xl border border-zinc-200 bg-zinc-50/70 p-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-sm font-semibold text-zinc-900">Transfer reservation between properties</h2>
                  </div>
                  <form action={transferAction} className="grid gap-3">
                    <div className="grid gap-2">
                      <Label htmlFor="wf-sourceReservationId">Source Reservation</Label>
                      <FormSelectField name="sourceReservationId" options={reservationOptions} placeholder="Select reservation" />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="wf-transferPropertyId">Target Property</Label>
                      <FormSelectField name="targetPropertyId" options={transferTargetPropertyOptions} placeholder="Select property" />
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="wf-transferRoomTypeId">Target Room Type</Label>
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <div className="grid gap-2">
                        ...
                        <Input id="wf-transferCheckIn" name="checkIn" type="date" required />
                      </div>
                      <div className="grid gap-2">
                        <Label htmlFor="wf-transferCheckOut">Check-out</Label>
                        <Input id="wf-transferCheckOut" name="checkOut" type="date" required />
                      </div>
                    </div>
